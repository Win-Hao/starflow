...
export const LOCALES = {
  zh: {
    ...
    'lab.text': '内容',
    'lab.textStyle': '写法',
    'lab.textStyle.galaxy': '星系体（原站的 6）',
    'lab.textStyle.stroke': '笔画中线',
    'lab.textStyleNote': '星系体目前只有 0–9：每位数字 5 条螺旋臂 + 一个星系核。含字母时自动改走笔画中线。',
    'lab.weight': '字重',
    'lab.icon': '图标',
    ...
    'lab.fillRatio': '填充占比',
    'lab.rasterStyle': '撒星',
    'lab.rasterStyle.converge': '原站 icon：星系汇聚成形',
    'lab.rasterStyle.paths': '路径形状撒星（厚实）',
    'lab.statsConverge': (count) => `${count.toLocaleString('zh-CN')} 颗星 · 星系汇聚成形状`,
    'lab.rasterStyle.plain': '普通轮廓',
    'lab.stroke': '星线',
    'lab.stroke.auto': '自动',
    'lab.stroke.center': '笔画中线',
    'lab.stroke.outline': '轮廓',
    'lab.strokeSpread': '笔画散布',
    'lab.scatter': '星带宽度',
  ...
  en: {
    ...
    'lab.text': 'Content',
    'lab.textStyle': 'Lettering',
    'lab.textStyle.galaxy': 'Galaxy digits (the original 6)',
    'lab.textStyle.stroke': 'Stroke centre-line',
    'lab.textStyleNote': 'Galaxy digits cover 0–9 only: five spiral arms and a core per digit. Letters fall back to stroke centre-lines.',
    'lab.weight': 'Weight',
    'lab.icon': 'Icon',
    ...
    'lab.rasterStyle': 'Star spread',
    'lab.rasterStyle.converge': 'Original icon: galaxy converges',
    'lab.rasterStyle.paths': 'Path-shape scatter (thick)',
    'lab.statsConverge': (count) => `${count.toLocaleString('en-US')} stars · galaxy converged into the shape`,
    'lab.rasterStyle.plain': 'Plain outline',
    'lab.stroke': 'Star lines',
    'lab.stroke.auto': 'Auto',
    'lab.stroke.center': 'Stroke centre-line',
    'lab.stroke.outline': 'Outline',
    'lab.strokeSpread': 'Stroke spread',
    ...
    'lab.kind.strokes': 'strokes',
    'lab.kind.galaxyText': 'galaxy digits',
