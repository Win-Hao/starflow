...
### Site Header
- Fixed, `64px` tall on desktop (`4rem`; `54px` below `1020px`). At the top of the page it is fully transparent over the canvas; as soon as the page scrolls a solid `#000000` surface fades in over `400ms cubic-bezier(0.33, 1, 0.68, 1)`, with a masked `brightness(95%) contrast(105%)` strip beneath it. No blur.
